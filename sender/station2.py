...
def main():
    ...
    print("Connected in second station\n\n")

    video_dir = os.path.join('\sender', 'videos')
    video_files = ["vid5.mp4", "vid6.mp4", "vid7.mp4", "vid8.mp4"]
...
#                     s.sendto(string, sin)
#                     print("Sent frame", i + 1)
#                     time.sleep(0.3)  # Simulate delay for video stream
